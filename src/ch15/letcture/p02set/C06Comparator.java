...
public class C06Comparator {
    public static void main(String[] args) {
        /*  (exception)
        var set = new TreeSet<C06Book>();
        set.add(new C06Book("이것이 자바다", 30000));
         */

//        var set = new TreeSet<C06Book>((a, b) -> a.getPrice() - b.getPrice());  // 가격순
        var set = new TreeSet<C06Book>((a, b) -> a.getTitle().compareTo(b.getTitle())); // 제목순 
        set.add(new C06Book("이것이 자바다", 30000));
